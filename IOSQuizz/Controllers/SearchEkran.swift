...
class SearchEkran : UIViewController {
    ...
    @IBAction func searchQuizzes(_ sender: Any) {
        let string = self.searchTextField.text ?? ""
        search(string: string)
    }
    
    
    func search(string: String){
        //bind view model, ali sa filterom
        print(string)
        self.viewModel = QuizViewModel()
        self.refresh()
        viewModel.fetchQuizzesWithSearch(string: string, completion: {
            self.refresh()
        })
        setupTableView()
    }
    ...
    extension SearchEkran : UITableViewDelegate {
    ...
    extension SearchEkran : UITableViewDataSource {
    ...
    extension SearchEkran : TableViewFooterViewDelegate {
        func logOut() {
...
extension SearchEkran : UIPageViewControllerDelegate {
